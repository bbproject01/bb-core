...
//         require(
//             _life >= life.min && _life <= life.max,
//             "CFA: Life is not within range"
//         );
//         _;
//     }
...
//      */
//     function mintBatch(
//         Attributes[] memory cfaAttributes,
...
//         require(
//             erc20Token.balanceOf(msg.sender) >= balanceToLock,
//             "CFA: Insufficient balance of ERC20 to lock"
//         );
...
//         require(
//             block.timestamp > (attribute.soulBoundTerm + attribute.timeCreated),
//             "CFA: CFA is locked"
//         );
...
//     function setMinimumErc20Balance(
//         uint256 _minimumErc20Balance
//     ) public onlyOwner {
//         minimumErc20Balance = _minimumErc20Balance;
//     }
...
//     ) public override {
//         require(
//             attributes[id].soulBoundTerm == 0,
//             "CFA: El CFA esta bloqueado y no se puede transferir"
//         );
...
//         require(
//             attributes[id].soulBoundTerm == 0,
//             "CFA: El CFA esta bloqueado y no se puede quemar"
//         );
...
//             require(
//                 attributes[ids[i]].soulBoundTerm == 0,
//                 "CFA: No se puede quemar un CFA bloqueado"
//             );
//         }
